...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "170D76"  # Playfab Title Id
        self.SecretKey: str = "YWGWDNCWHCTCEA9F8CICXUHZMZC8EXP7HI8QBE45YOPYTF1FWN"  # Playfab Secret Key
        self.ApiKey: str = "OC|1071335499403979|6fcddafc88b4cd22752b23931d022ee1"  # App Api Key (Oculus/Graph API)
